 ...
 * 🌊 Bate e volta em Rio das Ostras
 */
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Glows: Azul Praia e Dourado Areia */}
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 max-w-5xl mx-auto">
          ...
          {/* Coluna da Direita (Fotos, 6 colunas) */}
      ...
      {/* ---- EASTER EGG REAL WAVE ANIMATION ---- */}
      <AnimatePresence>
        {showWave && (
          <motion.div
