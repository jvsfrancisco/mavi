    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 max-w-5xl mx-auto">
              ...
              <div className="space-y-4 relative z-10">
                ...
                <div className="pt-4 flex items-center gap-2">
                  ...
                  <span
                    ...
                    onClick={() => {
                      // Confete duplo: Preto/Branco e Vermelho/Preto
          ...
          {/* Vídeo do Date (Meio, 3 colunas) */}
          <motion.div 
            className="md:col-span-3 flex flex-col justify-center h-full"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ margin: "200px" }}
            transition={{ duration: 0.6, delay: 0.3, ease: [0.16, 1, 0.3, 1] }}
          >
            <GlassCard className="p-3 relative group w-full h-full flex flex-col">
              <div className="relative w-full h-full min-h-[300px] rounded-xl overflow-hidden bg-neutral-900 border border-white/10 shadow-2xl flex-1">
                <iframe
                  src="https://www.youtube.com/embed/-U_4-zkZODo?autoplay=0&loop=1&playlist=-U_4-zkZODo&controls=1&modestbranding=1&rel=0"
          ...
          {/* Fotos com a camisa (Direita, 3 colunas) */}
          <motion.div
          ...
          >
            <div className="group relative flex-1 min-h-[180px] rounded-2xl overflow-hidden border border-white/10">
              ...
              <p className="absolute bottom-3 left-3 text-white/80 font-display italic text-xs">
                Rivais...
              </p>
            </div>
