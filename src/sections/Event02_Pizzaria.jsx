...
/**
 * Event02_Pizzaria
 * 🍕 Date na Vesuvio Carioca — Pizzaria familiar
 *
 * Features:
 * - Background com gradiente quente de pizzaria (vermelho, âmbar, marrom)
 * - Elementos SVG flutuantes (pizza, vela, manjericão)
 * - Vídeo em glassmorphism card com controles customizados
 * - Texto narrativo com microinterações
 * - Layout invertido (texto à esquerda, vídeo à direita)
 */
export default function Event02_Pizzaria() {
  ...
  // Parallax para o vídeo (entra do lado oposto)
  ...
  return (
    ...
    >
      {/* ---- Background Gradient (luz quente de pizzaria) ---- */}
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Glows quentes — simulam luzes de vela */}
        ...
        {/* Glow central mais suave — luz intimista */}
      ...
      >
        ...
        {/* ---- Grid: Texto + Vídeo (layout invertido) ---- */}
