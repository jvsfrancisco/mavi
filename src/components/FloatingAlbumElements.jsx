...
export default function FloatingAlbumElements() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden z-0">
      ...
      {/* Luzes de fundo OTIMIZADAS: Usando radial-gradient ao invés de blur() que trava o celular */}
      <motion.div 
        animate={{ scale: [1, 1.1, 1], opacity: [0.6, 0.8, 0.6] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        className="absolute top-[-10%] left-[-10%] w-[60vw] h-[60vw] md:w-[500px] md:h-[500px] rounded-full"
        style={{ background: 'radial-gradient(circle, rgba(255,77,109,0.2) 0%, transparent 70%)' }}
      />
      <motion.div 
        animate={{ scale: [1, 1.2, 1], opacity: [0.4, 0.6, 0.4] }}
        transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 2 }}
        className="absolute bottom-[-20%] right-[-10%] w-[70vw] h-[70vw] md:w-[600px] md:h-[600px] rounded-full"
        style={{ background: 'radial-gradient(circle, rgba(255,159,28,0.15) 0%, transparent 70%)' }}
      />
      ...
      <motion.div
        ...
        className="absolute top-[20%] left-[5%] md:left-[15%] opacity-60"
      >
      ...
      <motion.div
        ...
        className="absolute bottom-[30%] right-[5%] md:right-[10%] opacity-50"
      >
      ...
      <motion.div
        ...
        className="absolute bottom-[20%] left-[10%] md:left-[25%]"
      >
      ...
      <motion.div
        ...
        className="absolute top-[60%] left-[5%] md:left-[8%] opacity-40"
      >
        <div className="w-12 h-16 md:w-16 md:h-20 bg-white p-1 pb-3 md:pb-4 rounded-[2px] flex flex-col border border-white/20 shadow-[0_10px_20px_rgba(0,0,0,0.5)]">
