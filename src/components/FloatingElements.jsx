...
/**
 * FloatingElements
 * Elementos SVG flutuantes em parallax no fundo da seção.
 * Cada elemento se move em velocidades diferentes para criar profundidade.
 *
 * @param {object} props
 * @param {import("framer-motion").MotionValue} props.scrollProgress - Progresso do scroll (0→1)
 */
export default function FloatingElements({ scrollProgress }) {
  // Parallax em velocidades diferentes para cada layer
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      {/* ---- Segunda onda (mais clara, mais lenta) ---- */}
      <motion.div
      ...
      {/* ---- Batata Frita SVG (flutuando top-right) ---- */}
      <motion.div
      ...
      {/* ---- Hambúrguer SVG (flutuando bottom-left) ---- */}
      <motion.div
      ...
      {/* ---- Estrelinhas / Brilhos decorativos ---- */}
      {[...Array(6)].map((_, i) => (
        <motion.div
          key={i}
